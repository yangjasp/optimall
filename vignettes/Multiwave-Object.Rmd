...
*  **Samples:** The samples slot contains a character vector of the sample ids that were selected in the current wave.

* **Sampled Data:** The sampled data slot contains a data frame holding the data collected in a specific wave.

* **Data:** The data slot contains a data frame with the full data as it gets updated for each wave (or phase for phase 1). It is typically the sampled data merged with the (full) data of the previous wave. 
...
phase1_data_dictionary <- data.frame(
  "Variable" = c( "id", "race", "mat_weight_est", "diabetes"),
  "Description" = c("unique identifier", 
                    "race of mother",
