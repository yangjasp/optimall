...
wave1_data <- merge(phase1_data, wave1_sampled_data, by = "id", all.x = TRUE)
...
phase2a <- merge(phase1, phase2a_samples, by = "id", all.x = TRUE)
names(phase2a)
...
phase2b <- merge(phase2b, phase2b_samples, by = "id", all.x = TRUE)
...
phase2c <- merge(phase2c, phase2c_samples, by = "id", all.x = TRUE)
