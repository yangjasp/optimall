...
iris <- sample_strata(data1 = iris, strata1 = "Species", id = "id",
                               data2 = sampling_design, strata2 = "strata",
...
Note that `"data2"` is the output of `optimum_allocation` in this example, but in practice it can be any dataframe that has one row per stratum and one column specifying each stratum's desired sample size.
