...
#' multi-wave sampling workflow: \code{Wave}, \code{Phase}, and \code{Multiwave}.
#' An object of class \code{Multiwave} holds metadata and a list of objects of
#' class \code{Phase}, which in turn holds metadata and a list of objects of class
...
Phase <- setClass("Phase", slots = list(metadata = "list",
                               waves = "list"))
