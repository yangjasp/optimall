...
You can install the development version of `optimall` from [GitHub](https://github.com/) with:
...
You can install the beta version of `optimall` with the multiwave object additions with:
